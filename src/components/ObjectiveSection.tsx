      ...
      <div className="container mx-auto px-1 xs:px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 2xl:px-10 relative z-10">
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 p-3 sm:p-4 md:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 md:gap-4 lg:gap-5 mb-6 sm:mb-8 md:mb-10 max-w-md xs:max-w-lg sm:max-w-none mx-auto">
            ...
            <div className="group relative transform transition-all duration-700 hover:scale-102 xs:hover:scale-103 sm:hover:scale-104 md:hover:scale-105 animate-on-scroll-scale hover-card stagger-3">
          ...
          <div className="relative animate-fade-in px-1 xs:px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 2xl:px-12">
            ...
            <div className="relative max-w-xs xs:max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-4xl 2xl:max-w-5xl mx-auto text-center">
              ...
              <div className="relative group mb-4 xs:mb-5 sm:mb-6 md:mb-8 lg:mb-10 xl:mb-12 2xl:mb-16 max-w-full xs:max-w-sm sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl 2xl:max-w-4xl mx-auto">
                ...
                <div className="relative bg-card/90 backdrop-blur-md border border-blue-200/50 rounded-xl xs:rounded-2xl sm:rounded-2xl md:rounded-3xl lg:rounded-3xl xl:rounded-4xl p-3 xs:p-4 sm:p-5 md:p-6 lg:p-8 xl:p-10 2xl:p-12 shadow-lg xs:shadow-xl sm:shadow-xl md:shadow-2xl lg:shadow-2xl xl:shadow-3xl">
                  <div className="space-y-2 xs:space-y-3 sm:space-y-3 md:space-y-4 lg:space-y-5 xl:space-y-6 2xl:space-y-8">
                    ...
                    <p className="text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-foreground/90 font-semibold leading-relaxed max-w-full xs:max-w-xs sm:max-w-sm md:max-w-md lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl mx-auto px-1 xs:px-2 sm:px-2 md:px-3 lg:px-4">
                      Relions ce qui existe déjà pour faire basculer<br className="hidden md:block" /> 
              ...
              <div className="flex flex-col xs:flex-col sm:flex-row gap-2 xs:gap-3 sm:gap-3 md:gap-4 lg:gap-5 xl:gap-6 justify-center items-center max-w-full xs:max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl mx-auto px-2 xs:px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8">
                <Button 
                  className="w-full xs:w-full sm:w-auto btn-cta-blue font-semibold text-white px-4 xs:px-5 sm:px-6 md:px-7 lg:px-8 xl:px-10 py-2 xs:py-2.5 sm:py-2.5 md:py-3 lg:py-3.5 xl:py-4 rounded-lg xs:rounded-xl sm:rounded-xl md:rounded-xl lg:rounded-2xl text-xs xs:text-sm sm:text-sm md:text-base lg:text-base xl:text-lg h-10 xs:h-11 sm:h-12 md:h-13 lg:h-14 xl:h-15"
                >
                  ADHÉRER
                </Button>
