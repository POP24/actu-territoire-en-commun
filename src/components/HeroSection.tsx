          ...
          <div className="text-white space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            <div className="flex justify-center mt-8 sm:mt-12">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="center" className="z-[999] bg-card/95 backdrop-blur-md border border-border shadow-lg rounded-xl p-2 min-w-[260px] animate-scale-in">
                  <DropdownMenuItem asChild className="rounded-lg p-3 text-center hover:bg-orange-500/10 transition-all duration-200 cursor-pointer group border border-orange-500/20">
                  ...
                  <DropdownMenuItem asChild className="rounded-lg p-3 text-center hover:bg-blue-500/10 transition-all duration-200 cursor-pointer group border border-blue-500/20 mt-1">
