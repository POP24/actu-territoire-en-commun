          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            ...
            <div className="text-center">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="bg-card/50 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-border/20 shadow-soft">
                  <div className="text-sm sm:text-lg font-bold text-primary mb-1">Obligations</div>
                  <div className="text-xs sm:text-sm text-muted-foreground">Investissement sécurisé</div>
                </div>
                <div className="bg-card/50 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-border/20 shadow-soft">
                  <div className="text-sm sm:text-lg font-bold text-secondary mb-1">Crédits d'Usage</div>
                  <div className="text-xs sm:text-sm text-muted-foreground">Accès aux lieux</div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="bg-card/50 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-border/20 shadow-soft">
                  <div className="text-sm sm:text-lg font-bold text-accent mb-1">Budget Participatif</div>
                  <div className="text-xs sm:text-sm text-muted-foreground">Décisions collectives</div>
                </div>
                <div className="bg-card/50 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-border/20 shadow-soft">
                  <div className="text-sm sm:text-lg font-bold text-primary mb-1">Caisse Commune</div>
                  <div className="text-xs sm:text-sm text-muted-foreground">Mutualisation des ressources</div>
                </div>
              </div>
            </div>
          </div>
