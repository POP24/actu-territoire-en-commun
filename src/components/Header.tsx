        ...
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="z-[999] p-0 bg-gradient-national backdrop-blur-md border border-primary/20 shadow-elegant rounded-2xl min-w-[280px] animate-scale-in overflow-hidden">
