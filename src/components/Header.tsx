      ...
      <div className="container mx-auto px-4 sm:px-6">
        <nav className="flex items-center justify-between h-16 sm:h-18">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <a
              href="https://x.com/lasuitedumonde"
              target="_blank"
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              <Button 
                variant="outline" 
                size="sm"
                className="bg-orange-500 hover:bg-orange-600 text-white border-orange-500 hover:border-orange-600 px-3 py-2 h-10"
              >
                🏠
              </Button>
            </a>
