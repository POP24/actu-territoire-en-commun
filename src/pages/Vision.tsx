    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl mb-12 text-foreground max-w-3xl mx-auto">
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-4 text-foreground">Premiers Campings</h3>
              <p className="text-muted-foreground">(Dordogne)</p>
            </div>
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-4 text-foreground">Prochains lieux</h3>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-foreground">
            ...
            <ul className="mb-8 space-y-2">
              <li>Le temps de rencontrer un territoire, ses habitants, ses possibles.</li>
              <li>Le temps de tester des modes de vie, des métiers, des relations.</li>
              <li>Le temps d'explorer sans mobiliser tout son capital, sans s'engager trop vite.</li>
              <li>Le temps d'attendre de ne plus être seul avant de s'ancrer durablement.</li>
            </ul>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg text-center text-foreground mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-foreground">Des terres et des liens</h3>
              <p className="mb-4 text-foreground">Nous créerons des espaces d'accueil :</p>
              <ul className="space-y-2 mb-6 text-foreground">
                <li>• Campings partagés</li>
                <li>• Fermes collectives</li>
                <li>• Habitats légers</li>
                <li>• Espaces d'apprentissage</li>
              </ul>
              <p className="text-muted-foreground">Chaque lieu est une porte ouverte pour tester et s'installer.</p>
            </div>

            <div>
              <h3 className="text-2xl font-bold mb-6 text-foreground">Les ressources à partager</h3>
              <p className="mb-4 text-foreground">Nous mutualiserons :</p>
              <ul className="space-y-2 mb-6 text-foreground">
                <li>• Outils et savoirs</li>
                <li>• Réseaux d'entraide</li>
                <li>• Moyens de production</li>
                <li>• Espaces de stockage</li>
              </ul>
              <p className="text-muted-foreground">Rendre accessible ce qui semble hors de portée seul.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-foreground">
            ...
            <p className="mb-6">Mais cela ne suffit pas.</p>
            ...
            <p className="mb-6">Nous plantons des arbres aujourd'hui.</p>
            <p className="mb-6">Mais pas seulement pour les voir pousser.</p>
            <p>Nous plantons des racines de confiance. Des structures d'accueil. Des graines de liberté.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <div className="w-24 h-24 mx-auto mb-6 bg-primary/10 rounded-full flex items-center justify-center">
              <span className="text-2xl font-bold text-primary">LSM</span>
            </div>
            <h2 className="text-2xl font-bold mb-8 text-foreground">EN QUELQUES MOTS</h2>
          </div>
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-foreground">
            <p className="mb-4">Nous voulons permettre l'autogestion de grappes de terrains de vie et de production,</p>
            <p className="mb-4">Nous voulons expérimenter une organisation communaliste afin de faire communs et communes,</p>
            <p className="mb-4">Nous voulons multiplier les pratiques coopératives locales et connectées entre elles,</p>
            <p className="mb-4">Nous voulons, face à l'effondrement écologique, économique, démocratique, nous organiser,</p>
            <p className="mb-8">Aussi nous convenons de déclarer "Communes Imaginées" les lieux, outils et moments qui nous rassemblent.</p>

            <p className="mb-4">La Suite du Monde acquiert et contractualise à ces fins des terres et bâtis,</p>
            <p className="mb-4">Sur lesquels nous faisons le serment commun de nous confronter ensemble au monde,</p>
            <p className="mb-4">Le pacte de compter sur nos propres forces comme sources de nos libertés,</p>
            <p className="mb-4">Afin d'y vivre, apprendre, échanger et cultiver de façon solidaire,</p>
            <p className="mb-4">De préserver des terres de la prédation et de prendre soin du vivant,</p>
            <p className="mb-8">De veiller à la qualité de nos liens, tout en demeurant rejoignables.</p>
