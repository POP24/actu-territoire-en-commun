    ...
    <>
      ...
      <main className="container mx-auto px-6 pt-28 pb-16">
        ...
        <ScrollReveal animation="scale" delay={200}>
          <section aria-labelledby="montant" className="max-w-2xl mx-auto bg-card rounded-lg p-4 sm:p-6 shadow-soft hover:shadow-lg transition-all duration-300">
        ...
        <ScrollReveal animation="fade-up" delay={400}>
          <section className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mt-8 sm:mt-12" aria-label="Avantages">
            <article className="bg-card rounded-lg p-3 sm:p-5 shadow-soft hover:shadow-lg hover:scale-105 transition-all duration-300">
