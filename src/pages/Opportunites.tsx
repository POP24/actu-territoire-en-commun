      ...
      <main className="container mx-auto px-6 pt-40 lg:pt-60 pb-16">
        ...
        <ScrollReveal animation="scale" delay={300}>
          <section className="mt-6 sm:mt-10">
            <div className="bg-card rounded-xl overflow-hidden shadow-soft ring-2 ring-primary ring-offset-2 ring-offset-background shadow-lg shadow-primary/20 hover:shadow-2xl transition-all duration-300">
        ...
        <ScrollReveal animation="fade-up" delay={500}>
          <section className="mt-8 sm:mt-12 bg-card p-4 sm:p-6 rounded-lg sm:rounded-xl shadow-soft hover:shadow-lg hover:scale-105 transition-all duration-300">
